...
>
> DME Writing Engine is completely free to use as-is, with no restrictions or hidden limits, and we'd love to keep it that way. 🌱
>
...
> Enterprise licensing and sponsorship details can be configured by the project owner.
>
`}
			/>
		</div>
